...
Define the interchangeable translation providers (local MT engines and OpenAI-compatible LLM/VLM clients) behind a common interface. _(TBD: full purpose)_
